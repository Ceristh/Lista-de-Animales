...
const camposDelFormulario = [...document.querySelectorAll("input, select")];
...
form.addEventListener("submit", (e) => {
    ...
    ul.innerHTML += `<li>${mascotita.getTipo()}, mientras  que el nombre de la mascota es : ${mascotita.nombreMascota
